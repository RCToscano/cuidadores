...
export class EntrevistaAlteracaoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.colaboradorService.colaboradorEntrevista == undefined) {
      this.carregar = true;
      this.spinner.show();
      ...
      this.colaboradorService.consultaEntrevista(this.activatedRoute.snapshot.params['id'])
        ...
        error =>  {
          console.log(error);
          this.colaboradorService.colaboradorEntrevista = {} as ColaboradorEntrevista;
          this.spinner.hide();
          this.carregar = false;
        }
      );
      ...
      this.colaboradorEntrevista = this.colaboradorService.colaboradorEntrevista;
      this.criarForm();
    }
  }
